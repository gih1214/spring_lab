...
public class PostController {
    ...
    public String write(String title, String content, Model model) {
        ...
        return "post/list"; // 응답(request 사라짐)
    }
}
